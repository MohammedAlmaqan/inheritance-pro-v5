/**
 * نظام الكسور المُحسَّن - Enhanced Fraction System
 * مستخرج من Merath_Cluade_Pro7.html v5.0
 * يدعم جميع العمليات الحسابية على الكسور بدقة عالية
 */
...
export class Fraction {
  ...
  lessThanOrEqual(other: Fraction | number): boolean {
    return this.compareTo(other) <= 0;
  }

  greaterThanOrEqual(other: Fraction | number): boolean {
    return this.compareTo(other) >= 0;
  }
